...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <script type="text/javascript">
        ...
        function check() {
            ...
            if (!isEmpty(document.getElementById("passO").value))
                msg += "הכנס סיסמה ישנה" + "<br/>";
            if (!isEmpty(document.getElementById("passN").value))
                msg += "הכנס סיסמה חדשה" + "<br/>";
            if (document.getElementById("passN").value.length <= 8)
